          ...
          >
            <div className="text-center text-white">
              ...
              <p className="text-lg opacity-75 mb-2">
                Haz clic para agregar imagen de portada
              </p>
                ...
                {galleryImages.length > 0 ? (
                  ...
                  >
                    ...
                    <p className="text-gray-600 mb-6">
                      Comparte fotos de tus productos, tu proceso de trabajo, o
                      tu equipo
                    </p>
                    {isEditing && (
                      <motion.button
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      Así es como los compradores verán tu tienda. Haz clic en
                      "Editar Tienda" para personalizar tu historia y agregar
                      más fotos.
                    </p>
                  </div>
                </div>
